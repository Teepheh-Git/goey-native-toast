...
> Since the project relies on pnpm workspaces, you should use `pnpm` for development.
...
```sh
Running "GoeyNativeToastExample" with {"fabric":true,"initialProps":{"concurrentRoot":true},"rootTag":1}
```
